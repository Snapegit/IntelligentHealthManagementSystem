...
<template>
	<div>
			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('jiankangdangan','评级')" type="success" @click="jiankangpingjiCrossAddOrUpdateHandler(scope.row,'cross','','','')">评级</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
		...
		<jiankangpingjiFormModel ref="jiankangpingjiFormModelRef" @formModelChange="formModelChange"></jiankangpingjiFormModel>
	</div>
</template>
<script setup>
	...
	import jiankangpingjiFormModel from '@/views/jiankangpingji/formModel'
	const jiankangpingjiFormModelRef = ref(null)
    const jiankangpingjiCrossAddOrUpdateHandler = (row,type,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			jiankangpingjiFormModelRef.value.init(row.id,'cross','评级',row,'jiankangdangan',statusColumnName,tips,statusColumnValue)
		})
    }
	//初始化
	const init = () => {

				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="居民密码" prop="juminmima">
							<el-input class="list_inp" v-model="form.juminmima" placeholder="居民密码"
								type="password" :readonly="!isAdd||disabledForm.juminmima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='juminmima'){
					form.value.juminmima = row[x];
					disabledForm.value.juminmima = true;
					continue;
				}
				if(x=='juminxingming'){

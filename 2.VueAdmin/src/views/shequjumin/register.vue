	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">居民账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.juminzhanghao" 
						 placeholder="请输入居民账号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">居民密码：</div>
					<el-input class="list_inp"
						 v-model="registerForm.juminmima" 
						 placeholder="请输入居民密码"
						 type="password"
						 />
				</div>
				<div class="list_item">
					<div class="list_label">确认居民密码：</div>
					<el-input class="list_inp" v-model="registerForm.juminmima2" type="password" placeholder="请输入确认居民密码" />
				</div>
				<div class="list_item">
					<div class="list_label">居民姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.juminxingming" 
						 placeholder="请输入居民姓名"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.juminzhanghao)){
			context?.$toolUtil.message(`居民账号不能为空`,'error')
			return false
		}
		if((!registerForm.value.juminmima)){
			context?.$toolUtil.message(`居民密码不能为空`,'error')
			return false
		}
		if(registerForm.value.juminmima!=registerForm.value.juminmima2){
			context?.$toolUtil.message('两次密码输入不一致','error')
			return false
		}
		if((!registerForm.value.juminxingming)){

		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="8">
							<el-form-item prop="juminzhanghao" label="居民账号">
								<el-input class="list_inp" v-model="userForm.juminzhanghao" placeholder="居民账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="juminmima" label="居民密码">
								<el-input class="list_inp" v-model="userForm.juminmima" placeholder="居民密码" type="password"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="juminxingming" label="居民姓名">
								<el-input class="list_inp" v-model="userForm.juminxingming" placeholder="居民姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.juminzhanghao)
	...
	const updatePassword = async ()=>{
		passwordFormRef.value.validate(async (valid) => {
			if (valid) {
				if(passwordForm.value.mima != userForm.value.juminmima){
				...
				userForm.value.juminmima = passwordForm.value.newmima
				context?.$http({

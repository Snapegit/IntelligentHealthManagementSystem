					...
					<el-row>
						<el-col :span="8">
							<el-form-item prop="yishenggonghao" label="医生工号">
								<el-input class="list_inp" v-model="userForm.yishenggonghao" placeholder="医生工号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="yishengmima" label="医生密码">
								<el-input class="list_inp" v-model="userForm.yishengmima" placeholder="医生密码" type="password"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
						...
						<el-col :span="8">
							<el-form-item label="所属医院" prop="suoshuyiyuan">
								<el-select
									class="list_sel"
									v-model="userForm.suoshuyiyuan" 
									placeholder="请选择所属医院"
									style="width:100%;"
									>
									<el-option v-for="(item,index) in suoshuyiyuanLists" :label="item" :value="item">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="zhengzhimianmao" label="政治面貌">
								<el-input class="list_inp" v-model="userForm.zhengzhimianmao" placeholder="政治面貌" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="chushengdi" label="出生地">
								<el-input class="list_inp" v-model="userForm.chushengdi" placeholder="出生地" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item prop="lianxidizhi" label="联系地址">
								<el-input class="list_inp" v-model="userForm.lianxidizhi" placeholder="联系地址" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item label="问诊状态" prop="wenzhenzhuangtai">
								<el-select
									class="list_sel"
									v-model="userForm.wenzhenzhuangtai" 
									placeholder="请选择问诊状态"
									style="width:100%;"
									>
									<el-option v-for="(item,index) in wenzhenzhuangtaiLists" :label="item" :value="item">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.yishenggonghao)
	...
	const updatePassword = async ()=>{
		passwordFormRef.value.validate(async (valid) => {
			if (valid) {
				if(passwordForm.value.mima != userForm.value.yishengmima){
				...
				userForm.value.yishengmima = passwordForm.value.newmima
				context?.$http({

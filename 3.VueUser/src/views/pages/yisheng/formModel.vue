	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"86%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">所属医院</div>
					<div  class="info_text" >{{detail.suoshuyiyuan}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">出生地</div>
					<div  class="info_text" >{{detail.chushengdi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">联系地址</div>
					<div  class="info_text" >{{detail.lianxidizhi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">问诊状态</div>
					<div  class="info_text" >{{detail.wenzhenzhuangtai}}</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'问诊')" @click="jiankangwenzhenonAcross('问诊','jiankangwenzhen','','wenzhenzhuangtai','不可问诊','不可问诊,可问诊'.split(',')[0])" type="warning">问诊</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('yisheng','支付')" class="approval_btn" @click="payClick">支付</el-button>
...
<script setup>
	...
	const jiankangwenzhenonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {

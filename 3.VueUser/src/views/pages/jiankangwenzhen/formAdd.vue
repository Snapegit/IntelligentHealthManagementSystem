	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="问诊时间" prop="wenzhenshijian">
						<el-date-picker
							class="list_date"
							v-model="form.wenzhenshijian"
							format="YYYY 年 MM 月 DD 日"
							value-format="YYYY-MM-DD"
							type="datetime"
							:readonly="!isAdd||disabledForm.wenzhenshijian?true:false"
							placeholder="请选择问诊时间"
							style="width: 100%;" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='wenzhenshijian'){
					form.value.wenzhenshijian = row[x];
					disabledForm.value.wenzhenshijian = true;
					continue;
				}
				if(x=='neirong'){
